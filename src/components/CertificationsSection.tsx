      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {certifications.map((cert, index) => (
            <div key={index} className="bg-card p-6 rounded-xl border border-border hover:scale-105 transition-all duration-300" style={{ boxShadow: 'var(--soft-shadow)' }}>
              <div className="flex items-start mb-4">
                <div className="bg-[hsl(var(--pastel-blue))] p-3 rounded-lg mr-4">
                  <Award className="h-6 w-6 text-[hsl(var(--pastel-blue-foreground))]" />
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-semibold text-foreground mb-2">{cert.title}</h3>
                  <p className="text-[hsl(var(--pastel-blue-foreground))] font-medium mb-1">{cert.issuedBy}</p>
              ...
              <Button 
                ...
                className="bg-background border-border text-foreground hover:bg-[hsl(var(--pastel-blue))]/20 hover:border-[hsl(var(--pastel-blue-foreground))]/50 transition-all duration-300 group"
              >

    ...
    <>
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative transition-all duration-300" style={{ backgroundColor: '#F5F5DC' }}>
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full blur-3xl animate-pulse" style={{ backgroundColor: 'rgba(255, 145, 77, 0.1)' }}></div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="text-center lg:text-left space-y-6 animate-fade-in">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight" style={{ color: '#3E2723' }}>
                  Sai <span style={{ color: '#FF914D' }}>Kiran</span>
                </h1>
                ...
                <div className="space-y-4 max-w-2xl mx-auto lg:mx-0" style={{ color: '#4B3832' }}>
                  ...
                  <div className="hidden md:block">
                    <p className="text-base lg:text-lg leading-relaxed">
                      ...
                      <span className="font-medium" style={{ color: '#FF914D' }}> React, Node.js, and Firebase</span> while exploring the 
                      fascinating world of <span className="font-medium" style={{ color: '#FF914D' }}>artificial intelligence</span>.
                    </p>
                  ...
                  <div className="md:hidden">
                    <p className="text-base leading-relaxed">
                      ...
                      <span className="font-medium" style={{ color: '#FF914D' }}> React, Node.js</span> and exploring 
                      <span className="font-medium" style={{ color: '#FF914D' }}> AI</span>.
                    </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start pt-4">
                  <Button 
                    ...
                    onMouseEnter={(e) => e.target.style.backgroundColor = '#E07A40'}

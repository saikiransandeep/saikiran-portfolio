...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900 transition-all duration-300 pt-12 md:pt-16">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="text-center lg:text-left space-y-4 md:space-y-6 animate-fade-in">
                ...
                <h2 className="text-base sm:text-lg lg:text-2xl text-gray-300 leading-relaxed">
                  Computer Science Student | Programming Enthusiast
                </h2>
                
                <div className="text-gray-400 space-y-3 max-w-2xl mx-auto lg:mx-0">
                ...
                <div className="flex flex-col sm:flex-row gap-3 md:gap-4 items-center justify-center lg:justify-start pt-4">
                  <Button 
                    size="lg" 
                    className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-6 md:px-8 py-2 md:py-3 rounded-lg transition-all duration-300 hover:scale-105 text-sm md:text-base"
                  ...
                  <Button 
                    variant="outline" 
                    size="lg"
                    className="w-full sm:w-auto bg-blue-50 border-blue-200 text-blue-700 hover:bg-blue-100 hover:text-blue-800 hover:border-blue-300 px-6 md:px-8 py-2 md:py-3 rounded-lg transition-all duration-300 hover:scale-105 text-sm md:text-base"
              ...
              <div className="flex justify-center items-center order-first lg:order-last animate-scale-in">
                <div className="w-48 h-48 md:w-64 md:h-64 lg:w-80 lg:h-80 rounded-2xl bg-gradient-to-br from-gray-800/50 to-gray-700/50 border border-gray-600/30 flex items-center justify-center backdrop-blur-sm transition-all duration-300 hover:scale-105">
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <ChevronDown className="text-white/60 h-6 w-6 md:h-8 md:w-8" />
        </div>
      </section>
    </>
  );

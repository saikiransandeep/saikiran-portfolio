        ...
        <div className="max-w-4xl mx-auto">
          <div className="p-8 rounded-lg shadow-2xl hover:scale-105 transition-all duration-300" style={{ backgroundColor: '#4B3832' }}>
            <div className="flex items-center mb-6">
              <div className="p-4 rounded-full mr-6" style={{ backgroundColor: '#FF914D' }}>
              ...
              <div>
                ...
                <p className="text-xl font-semibold" style={{ color: '#FF914D' }}>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="flex items-center" style={{ color: '#F5F5DC' }}>
                  <MapPin className="h-5 w-5 mr-3" style={{ color: '#FF914D' }} />
                  <span className="font-medium">Avanthi Institute of Engineering and Technology</span>
                </div>
                
                <div className="flex items-center" style={{ color: '#F5F5DC' }}>
                  <Calendar className="h-5 w-5 mr-3" style={{ color: '#FF914D' }} />
                  <span>2022 – 2026</span>
                </div>
                
                <div className="flex items-center" style={{ color: '#F5F5DC' }}>
                  <TrendingUp className="h-5 w-5 mr-3" style={{ color: '#FF914D' }} />
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2" style={{ color: '#F5F5DC' }}>
                  <li className="flex items-center">
                    <span className="w-2 h-2 rounded-full mr-3" style={{ backgroundColor: '#FF914D' }}></span>
                    Final Year Student
                  </li>
                  <li className="flex items-center">
                    <span className="w-2 h-2 rounded-full mr-3" style={{ backgroundColor: '#FF914D' }}></span>
